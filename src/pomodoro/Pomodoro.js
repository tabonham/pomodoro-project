...
function Pomodoro() {
  ...
  //handle functions for focus, break
...
//eventHandles
  return (
    <div className="pomodoro">
      <div className="row">
        <Focus
        focusIncrease={handleIncreaseFocus}
        focusDecrease={handleDecreaseFocus}
        focusDuration={focusDuration}
        session={session}
        />
        <BreakControl
        breakIncrease={handleIncreaseBreak}
        breakDecrease={handleDecreaseBreak}
